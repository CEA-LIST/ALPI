...
__C.TRAIN.WEIGHTS = ''#'output/pretrain_on_fake.pth'
...
# pseudo-labeling iteration step and ratio of fake/real
...
def load_cfg(cfg_to_load):
    ...
    return yaml.full_load(cfg_to_load)
